        ...
        if(!recurso.id){
            ...
            .then((responde) => {
                ...
                toast.current?.show({
                    severity: 'error',
                    summary: 'Erro',
                    detail: 'Erro ao alterar recurso',
                });
            });
        }
    ...
    const deleteSelectedRecursos = () => {
        Promise.all(selectedRecursos.map(async (_recurso) => {
            ...
            toast.current?.show({
                severity: 'error',
                summary: 'Erro',
                detail: 'Erro ao excluir recursos',
                life: 3000
            });
        });
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Mostrando {first} até {last} dos {totalRecords} recursos"
